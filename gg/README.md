...
- `eliminator`: tramite regex e tante opzioni ti permette di eliminare con precisione e velocita grandi quantità di file
	...
	- Puoi ottenere una preview delle eliminazioni che verranno fatte utilizzando il l'argomento `--debug` oppure `-d`

1. Questa è una lista ordinata
2. seconda posizione
3. terza

> Avvertenze: lorem ipsum